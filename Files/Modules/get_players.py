...
def get_players(strat_count: dict) -> dict[int, str]:
    """ Create a list of players based on the number of players per strategy.

    Args:
        strat_count (dict): The strategies and how many players have this strat
...
# print(get_players({'minimax': 2, 'maxmin': 3, 'minimax_regret': 4, 'social_welfare': 5})) # Debugging example
